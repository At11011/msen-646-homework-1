  ...
  \item $R_\text{total}, V_\text{total}, I_\text{total}, I_1, I_2, I_3$?
    ...
    \boxedanswer{
      ...
      \begin{tabular}{|c|c|c|c|}
        ...
        Component & $\Delta V$ & $I$ & R \\
        \hline
        $E_1$ & \SI{20}{\volt} & \SI{8}{\ampere} & \SI{0}{\ohm} \\
        \hline
      ...
      \begin{align*}
        ...
        \Aboxed{I_\text{total} &= \SI{8}{\ampere}} \\
  ...
  \item Perform the following reference conversions
    ...
    \boxedanswer{
      \begin{align*}
        ...
        (\SI{241}{\milli\volt} - \SI{316}{\milli\volt}) \\
        E_{\text{CSE}} &= \SI{150}{\milli\volt} - \SI{75}{\milli\volt} \\
        \Aboxed{E_{\text{CSE}} &= \SI{75}{\milli\volt}} \\
        \\
        ...
        (\SI{241}{\milli\volt} - \SI{316}{\milli\volt}) \\
        E_{\text{CSE}} &= \SI{-150}{\milli\volt} - \SI{75}{\milli\volt} \\
        \Aboxed{E_{\text{CSE}} &= \SI{-225}{\milli\volt}} \\
        \\
        ...
        \SI{0.316}{\volt}) \\
        E_{\text{CSE}} &= \SI{0.00}{\volt} - \SI{1.079}{\volt} \\
        \Aboxed{E_{\text{CSE}} &= \SI{-1.079}{\volt}} \\
        \\
